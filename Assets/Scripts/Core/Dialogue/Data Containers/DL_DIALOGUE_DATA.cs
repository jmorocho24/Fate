...
{
    public List<DL_DIALOGUE_DATA> segments;
    private const string segmetIdentifierPattern = @"\{[ca]\}|\{m[ca]\s\d*\.?\d*}";
    ...
    public List<DIALOGUE_SEGMENT> RipSegments(string rawDialogue)
    {
        ...
        MatchCollection matches = Regex.Matches(rawDialogue, segmetIdentifierPattern);
